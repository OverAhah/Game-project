...
class Question2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Plot1.text = "После совета, было принято решения отправить с вами кого-то ещё на ваше усматрение. Кого вы выберет?"
        ...
        Answer5.text =                                                                                                                                                              "Красивая дочь дворянина любит балы. Её больше интересует любовь нежели власть"
